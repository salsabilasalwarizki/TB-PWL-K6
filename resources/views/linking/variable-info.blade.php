@extends('layouts.app')
@section('title', 'Link External Dataset - Variable Info - DataSphere ML Repository')
@section('meta_desc', 'Step 5: Provide variable information for your linked external dataset')
                ...
                <div class="p-5 md:p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex justify-between mt-1.5">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400"><span id="class_labelsCount">{{ strlen(old('class_labels', $data['class_labels'] ?? '')) }}</span>/5000</p>
                        </div>
                        @error('class_labels')
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="var-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 transition-all resize-none">{{ old('variable_info', $data['variable_info'] ?? '') }}</textarea>
                        <div class="flex justify-between mt-1.5">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400"><span id="variable_infoCount">{{ strlen(old('variable_info', $data['variable_info'] ?? '')) }}</span>/10000</p>
                        </div>
                        @error('variable_info')
                        <p class="mt-2 text-xs text-red-500 flex items-center gap-1">
                            <i class="bi bi-exclamation-circle"></i>{{ $message }}
