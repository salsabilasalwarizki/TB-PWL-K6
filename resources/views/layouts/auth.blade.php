                ...
                <div class="hidden xl:flex items-center gap-1">
                    ...
                    <div class="relative group">
                        ...
                        <div class="dropdown-menu-custom absolute left-0 mt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                            ...
                            <a href="{{ route('contribute.linking.metadata') }}" class="dropdown-item-custom text-gray-700 dark:text-gray-200">
            ...
            <div class="flex flex-col h-full">
                ...
                <div class="flex-1 overflow-y-auto py-4">
                    <div class="px-4 space-y-1">
                        @auth
                            @if(auth()->user()->role === 'admin' || auth()->user()->role === 'superadmin')
                                <a href="{{ route('admin.dashboard') }}" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 font-medium">
                        ...
                        <a href="{{ route('datasets.index') }}" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                        ...
                        <a href="{{ route('contribute.policy') }}" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                            <i class="bi bi-cloud-arrow-up text-lg text-green-500"></i>
                            <span>Donate New</span>
                        </a>
                        <a href="{{ route('contribute.linking.metadata') }}" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                        ...
                        <a href="{{ route('about.who-we-are') }}" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                            <i class="bi bi-people-fill text-lg text-brand-500"></i>
                            <span>Who We Are</span>
                        </a>
                        <a href="{{ route('about.citation') }}" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                            <i class="bi bi-quote text-lg text-purple-500"></i>
                            <span>Citation Metadata</span>
                        </a>
                        <a href="{{ route('about.contact') }}" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                        ...
                        @auth
                            ...
                            <a href="{{ route('profile') }}" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                                <i class="bi bi-person-circle text-lg text-brand-500"></i>
                                <span>My Profile</span>
                            </a>
                            <a href="{{ route('profile.datasets') }}" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                ...
                <div class="p-4 border-t border-gray-200 dark:border-gray-700 space-y-2 bg-gray-50 dark:bg-gray-800/50">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="mobile-menu-item w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-r from-brand-600 to-sphere-secondary text-white font-semibold shadow-lg hover:shadow-xl transition-all">
                            <i class="bi bi-box-arrow-in-right"></i>
                            <span>Login</span>
                        </a>
                    @endauth
