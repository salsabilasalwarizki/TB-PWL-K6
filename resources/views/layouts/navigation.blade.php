...
<div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
    ...
    <x-nav-link :href="route('datasets.index')" :active="request()->routeIs('datasets.*')">
        {{ __('Datasets') }}
    </x-nav-link>
...
<div class="relative" x-data="{ contributeOpen: false }">
    <button 
        ...
        @click.away="contributeOpen = false"
...
<!-- ✅ End Contribute Dropdown -->
    ...
    <div class="pt-2 pb-2 pl-6 space-y-1 border-l-4 border-gray-200">
        ...
        <x-responsive-nav-link :href="route('contribute.linking')" class="pl-4">
            {{ __('Link External') }}
        </x-responsive-nav-link>
    </div>
