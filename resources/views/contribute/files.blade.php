@extends('layouts.app')
@section('title', 'Dataset Donation - Files - DataSphere ML Repository')
@section('meta_desc', 'Step 4: Upload your dataset files')
                    ...
                    <div class="p-5 md:p-6">
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                    ...
                                    <tr class="hover:bg-violet-50/50 dark:hover:bg-violet-900/10 transition-colors variable-row">
                                        <td class="px-3 py-2 text-center">
                                            <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-violet-100 dark:bg-violet-900/30 text-violet-600 dark:text-violet-400 text-xs font-bold var-number">{{ $idx + 1 }}</span>
                                        </td>
                                        <td class="px-3 py-2">
                                        ...
                                        <td class="px-3 py-2">
                                            <select class="w-full px-2 py-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-violet-500 appearance-none cursor-pointer" 
                                                    name="variables[{{ $idx }}][role]">
                                                <option value="Feature" {{ ($var['role'] ?? 'Feature') == 'Feature' ? 'selected' : '' }}>Feature</option>
                                        ...
                                        <td class="px-3 py-2">
                                            <select class="w-full px-2 py-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-violet-500 appearance-none cursor-pointer" 
                                                    name="variables[{{ $idx }}][type]">
                                                <option value="Continuous" {{ ($var['type'] ?? 'Continuous') == 'Continuous' ? 'selected' : '' }}>Continuous</option>
                                                <option value="Categorical" {{ ($var['type'] ?? '') == 'Categorical' ? 'selected' : '' }}>Categorical</option>
                                                <option value="Integer" {{ ($var['type'] ?? '') == 'Integer' ? 'selected' : '' }}>Integer</option>
                                                <option value="Real" {{ ($var['type'] ?? '') == 'Real' ? 'selected' : '' }}>Real</option>
                                            </select>
                                        </td>
                                        <td class="px-3 py-2">
                                            <input type="text" class="w-full px-3 py-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500/20 transition-all" 
                                                   name="variables[{{ $idx }}][demo]" 
                                                   value="{{ $var['demo'] ?? '' }}"
                                                   placeholder="Optional">
                                        </td>
                                        <td class="px-3 py-2">
                                            <input type="text" class="w-full px-3 py-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500/20 transition-all" 
                                                   name="variables[{{ $idx }}][desc]" 
                                                   value="{{ $var['desc'] ?? '' }}"
                                                   placeholder="Description">
                                        </td>
                                        <td class="px-3 py-2">
                                            <input type="text" class="w-full px-3 py-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500/20 transition-all" 
                                                   name="variables[{{ $idx }}][units]" 
                                                   value="{{ $var['units'] ?? '' }}"
                                                   placeholder="Units">
                                        </td>
                                        <td class="px-3 py-2 text-center">
                                            <label class="relative inline-flex items-center cursor-pointer">
                                                <input type="checkbox" 
                                                       name="variables[{{ $idx }}][missing]" 
                                                       value="1"
                                                       {{ ($var['missing'] ?? 0) ? 'checked' : '' }}
                                                       class="sr-only peer">
                        ...
                        <div class="lg:hidden space-y-3" id="mobileVariablesContainer">
                            ...
                            <div class="mobile-variable-card bg-gradient-to-br from-violet-50/50 to-purple-50/50 dark:from-gray-700/30 dark:to-gray-700/30 border-2 border-violet-200 dark:border-violet-800/50 rounded-xl p-4">
                                <div class="flex items-center justify-between mb-3">
                                    <div class="flex items-center gap-2">
                                        <span class="inline-flex items-center justify-center w-7 h-7 rounded-full bg-violet-500 text-white text-xs font-bold var-number">{{ $idx + 1 }}</span>
                                        <span class="text-sm font-bold text-gray-900 dark:text-white">Variable {{ $idx + 1 }}</span>
                                    </div>
                                </div>
                                <div class="space-y-2">
                                    <input type="text" class="w-full px-3 py-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-violet-500" 
                                           name="variables[{{ $idx }}][name]" value="{{ $var['name'] ?? '' }}" placeholder="Variable name *">
                                    ...
                                    <input type="text" class="w-full px-3 py-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-violet-500" 
                                           name="variables[{{ $idx }}][demo]" value="{{ $var['demo'] ?? '' }}" placeholder="Demographic">
                                    <input type="text" class="w-full px-3 py-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-violet-500" 
                                           name="variables[{{ $idx }}][desc]" value="{{ $var['desc'] ?? '' }}" placeholder="Description">
                                    <input type="text" class="w-full px-3 py-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-violet-500" 
                                           name="variables[{{ $idx }}][units]" value="{{ $var['units'] ?? '' }}" placeholder="Units">
                                    <label class="flex items-center justify-between p-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600">
                                        ...
                                        <input type="checkbox" name="variables[{{ $idx }}][missing]" value="1" {{ ($var['missing'] ?? 0) ? 'checked' : '' }} class="w-4 h-4 rounded border-gray-300 text-violet-600 focus:ring-violet-500">
                                    </label>
                                </div>
                            </div>
                            @endforeach
