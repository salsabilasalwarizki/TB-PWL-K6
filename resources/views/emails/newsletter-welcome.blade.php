                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%;">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 50%, #06b6d4 100%); padding: 40px 30px; text-align: center; border-radius: 16px 16px 0 0;">
                            ...
                            <h1 style="color: white; margin: 0; font-size: 28px; font-weight: 700;">DataSphere</h1>
                            <p style="color: rgba(255,255,255,0.9); margin: 5px 0 0 0; font-size: 14px;">Machine Learning Repository</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: white; padding: 40px 30px;">
                            ...
                            <p style="color: #4b5563; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                                Hi there! Thank you for subscribing to the <strong style="color: #6366f1;">DataSphere Newsletter</strong>. 
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 12px;">
                                                    ...
                                                    <p style="color: #6b7280; font-size: 13px; margin: 4px 0 0 0;">Be the first to know about curated ML datasets</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 12px;">
                                                    ...
                                                    <p style="color: #6b7280; font-size: 13px; margin: 4px 0 0 0;">Latest findings in machine learning</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 12px;">
                                                    ...
                                                    <p style="color: #6b7280; font-size: 13px; margin: 4px 0 0 0;">New features and improvements</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ url('/') }}" style="display: inline-block; background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%); color: white; text-decoration: none; padding: 14px 32px; border-radius: 50px; font-weight: 600; font-size: 14px; box-shadow: 0 4px 12px rgba(99, 102, 241, 0.3);">
                                            Explore Datasets →
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.6; margin: 20px 0 0 0;">
                                ...
                                <a href="mailto:dataspheremlrepository@gmail.com" style="color: #6366f1; text-decoration: none;">dataspheremlrepository@gmail.com</a>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: #1f2937; padding: 30px; text-align: center; border-radius: 0 0 16px 16px;">
                            <p style="color: #9ca3af; font-size: 13px; margin: 0 0 10px 0;">
                                © {{ date('Y') }} DataSphere ML Repository. All rights reserved.
                            </p>
