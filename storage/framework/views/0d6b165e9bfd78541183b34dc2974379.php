...
<?php $__env->startSection('title', 'Link External Dataset - Keywords - DataSphere ML Repository'); ?>
<?php $__env->startSection('meta_desc', 'Step 4: Add keywords for your linked external dataset'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-brand-50/30 to-sphere-secondary/10 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 py-8 md:py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative max-w-4xl mx-auto">
        ...
        <form action="<?php echo e(route('contribute.linking.keywords.store')); ?>" method="POST" id="keywordsForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-5 md:p-6 sticky bottom-4">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                    <a href="<?php echo e(route('contribute.linking.creators')); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/linking/keywords.blade.php ENDPATH**/ ?>