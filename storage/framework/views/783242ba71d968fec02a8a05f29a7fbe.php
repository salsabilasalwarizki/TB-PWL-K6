...
<?php $__env->startSection('title', 'My Datasets - DataSphere Machine Learning Repository'); ?>
                    ...
                    <div class="p-4 border-t border-gray-100 dark:border-gray-700">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center justify-between p-2 rounded-lg bg-gray-50 dark:bg-gray-700/30">
                                ...
                                <span class="text-sm font-bold text-gray-900 dark:text-white"><?php echo e($datasets->total()); ?></span>
                            </div>
                            <div class="flex items-center justify-between p-2 rounded-lg bg-green-50 dark:bg-green-900/20">
                                ...
                                <span class="text-sm font-bold text-green-700 dark:text-green-400">
                                    <?php echo e($datasets->where('status', 'approved')->count()); ?>
                            ...
                            <div class="flex items-center justify-between p-2 rounded-lg bg-amber-50 dark:bg-amber-900/20">
                                ...
                                <span class="text-sm font-bold text-amber-700 dark:text-amber-400">
                                    <?php echo e($datasets->where('status', 'pending')->count()); ?>
                            ...
                            <div class="flex items-center justify-between p-2 rounded-lg bg-red-50 dark:bg-red-900/20">
                                ...
                                <span class="text-sm font-bold text-red-700 dark:text-red-400">
                                    <?php echo e($datasets->where('status', 'rejected')->count()); ?>
                        ...
                        <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($datasets->total()); ?> total datasets</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                        ...
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                            ...
                                            <td class="px-6 py-4">
                                                ...
                                                <div class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                                    <?php echo e($dataset->donated_date?->diffForHumans() ?? ''); ?>
                                            ...
                                            <td class="px-6 py-4">
                                                ...
                                                ?>
                                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold border <?php echo e($statusStyles); ?>">
                        ...
                        <div class="md:hidden divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <div class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                <div class="flex items-start gap-3 mb-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                            <i class="bi bi-calendar me-1"></i><?php echo e($dataset->donated_date?->format('M d, Y') ?? 'N/A'); ?>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    ?>
                                    <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold <?php echo e($statusStyles); ?>">
                                        <i class="bi bi-<?php echo e($statusIcon); ?>"></i>
                                        <?php echo e(strtoupper($status)); ?>
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <?php $primaryFile = $dataset->files->first(); ?>
                                        <?php if($primaryFile): ?>
                                            <a href="<?php echo e(route('datasets.download', [$dataset, $primaryFile])); ?>" 
                            ...
                            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-sm text-gray-600 dark:text-gray-400">
                                        <?php echo e($datasets->firstItem() ?? 0); ?> to <?php echo e($datasets->lastItem() ?? 0); ?> of <?php echo e($datasets->total()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/profile/datasets.blade.php ENDPATH**/ ?>