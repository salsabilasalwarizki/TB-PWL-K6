...
<?php $__env->startSection('title', 'Contact Us - DataSphere'); ?>
<?php $__env->startSection('meta_desc', 'Get in touch with the DataSphere Machine Learning Repository team'); ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 md:p-8">
                    ...
                    <div class="mb-4 p-4 rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-green-700 dark:text-green-300 mt-0.5"><?php echo e(session('success')); ?></p>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="mb-4 p-4 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-red-700 dark:text-red-300 mt-0.5"><?php echo e(session('error')); ?></p>
                        </div>
                    </div>
                    <?php endif; ?>
                    
                    <form action="<?php echo e(route('about.contact.send')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="name" value="<?php echo e(old('name', auth()->user()->name ?? '')); ?>" required
                                       class="w-full px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition-all <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" value="<?php echo e(old('email', auth()->user()->email ?? '')); ?>" required
                                       class="w-full px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition-all <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="subject" required
                                    class="w-full px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition-all <?php $__errorArgs = ['subject'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="Bug Report" <?php echo e(old('subject') == 'Bug Report' ? 'selected' : ''); ?>>Bug Report</option>
                                <option value="Feature Request" <?php echo e(old('subject') == 'Feature Request' ? 'selected' : ''); ?>>Feature Request</option>
                                <option value="Dataset Submission" <?php echo e(old('subject') == 'Dataset Submission' ? 'selected' : ''); ?>>Dataset Submission</option>
                                <option value="Citation Issue" <?php echo e(old('subject') == 'Citation Issue' ? 'selected' : ''); ?>>Citation Issue</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="message" rows="6" required
                                      class="w-full px-4 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition-all resize-none <?php $__errorArgs = ['message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 md:p-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <details class="group rounded-xl bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700 overflow-hidden">
                            ...
                            <div class="px-4 pb-4 text-sm text-gray-600 dark:text-gray-400">
                                Each dataset page has a "Cite" button that generates the correct citation format in BibTeX and APA styles. Visit our <a href="<?php echo e(route('about.citation')); ?>" class="text-brand-600 dark:text-brand-400 hover:underline">Citation Metadata</a> page for more details.
                            </div>
                        </details>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/about/contact.blade.php ENDPATH**/ ?>