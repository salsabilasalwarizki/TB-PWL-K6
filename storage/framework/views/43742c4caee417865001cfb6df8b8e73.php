    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white dark:bg-ink-900 rounded-xl shadow-card border border-ink-200 dark:border-ink-800 p-6 hover:shadow-elev hover:-translate-y-1 transition-all duration-300 animate-slide-up" style="animation-delay: 0.1s;">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-2xl font-bold text-ink-900 dark:text-white"><?php echo e(number_format($stats['total_datasets'] ?? 0)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-ink-900 rounded-xl shadow-card border border-ink-200 dark:border-ink-800 p-6 hover:shadow-elev hover:-translate-y-1 transition-all duration-300 animate-slide-up" style="animation-delay: 0.2s;">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-2xl font-bold text-ink-900 dark:text-white"><?php echo e(number_format($stats['pending_datasets'] ?? 0)); ?></p>
                    </div>
                </div>
                <?php if(($stats['pending_datasets'] ?? 0) > 0): ?>
                <div class="mt-3 pt-3 border-t border-ink-200 dark:border-ink-800">
                    <a href="<?php echo e(route('datasets.index', ['status' => 'pending'])); ?>" class="text-sm text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300 hover:underline">
            ...
            <div class="bg-white dark:bg-ink-900 rounded-xl shadow-card border border-ink-200 dark:border-ink-800 p-6 hover:shadow-elev hover:-translate-y-1 transition-all duration-300 animate-slide-up" style="animation-delay: 0.3s;">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-2xl font-bold text-ink-900 dark:text-white"><?php echo e(number_format($stats['approved_datasets'] ?? 0)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-ink-900 rounded-xl shadow-card border border-ink-200 dark:border-ink-800 p-6 hover:shadow-elev hover:-translate-y-1 transition-all duration-300 animate-slide-up" style="animation-delay: 0.4s;">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-2xl font-bold text-ink-900 dark:text-white"><?php echo e(number_format($stats['total_users'] ?? 0)); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white dark:bg-ink-900 rounded-xl shadow-card border border-ink-200 dark:border-ink-800 overflow-hidden">
                    <div class="px-6 py-4 border-b border-ink-200 dark:border-ink-800 flex items-center justify-between bg-gradient-to-r from-ink-50 to-ink-100 dark:from-ink-900 dark:to-ink-800">
                        ...
                        <a href="<?php echo e(route('datasets.index', ['status' => 'pending'])); ?>" class="text-sm text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 hover:underline">
                                ...
                                <tr class="hover:bg-ink-50 dark:hover:bg-ink-900/50 transition-colors duration-200">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <img src="<?php echo e($dataset->thumbnail_url); ?>" alt="" class="w-10 h-10 rounded-lg object-cover shadow-soft">
                                            <?php else: ?>
                                            ...
                                            <?php endif; ?>
                                            <div>
                                                <a href="<?php echo e(route('datasets.show', $dataset)); ?>" class="font-semibold text-ink-900 dark:text-white hover:text-brand-600 dark:hover:text-brand-400 hover:underline">
                                                    <?php echo e(Str::limit($dataset->name, 30)); ?>

                                                </a>
                                                <?php if($dataset->subject_area): ?>
                                                <p class="text-xs text-ink-500 dark:text-ink-400"><?php echo e($dataset->subject_area); ?></p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-sm text-ink-600 dark:text-ink-400">
                                        ...
                                        ?>
                                        <?php echo e($donator->name ?? 'Unknown'); ?>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            <a href="<?php echo e(route('datasets.show', $dataset)); ?>" class="p-2 text-ink-600 dark:text-ink-400 hover:text-brand-600 dark:hover:text-brand-400 hover:bg-ink-100 dark:hover:bg-ink-800 rounded-lg transition-all duration-200" title="View">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            <form action="<?php echo e(route('admin.datasets.approve', $dataset)); ?>" method="POST" class="inline">
                                                <?php echo csrf_field(); ?>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-ink-900 rounded-xl shadow-card border border-ink-200 dark:border-ink-800 overflow-hidden">
                    ...
                    <div class="divide-y divide-ink-200 dark:divide-ink-800">
                        ...
                        <a href="<?php echo e(route('datasets.show', $activity)); ?>" class="block px-6 py-4 hover:bg-ink-50 dark:hover:bg-ink-900/50 transition-colors duration-200">
                            <div class="flex items-start justify-between">
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm text-ink-500 dark:text-ink-400">
                                        ...
                                        • <span class="inline-flex px-2 py-0.5 text-xs font-medium rounded-lg <?php echo e($activity->status === 'pending' ? 'bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400' : 'bg-ink-100 dark:bg-ink-800 text-ink-700 dark:text-ink-400'); ?>">
        ...
        <div class="mt-8 pt-6 border-t border-ink-200 dark:border-ink-800 animate-slide-up" style="animation-delay: 0.6s;">
            <div class="flex flex-wrap gap-3 justify-center">
                <a href="<?php echo e(route('admin.users.index')); ?>" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-ink-700 dark:text-ink-300 bg-white dark:bg-ink-900 border border-ink-300 dark:border-ink-700 rounded-lg hover:bg-ink-50 dark:hover:bg-ink-800 hover:shadow-soft hover:-translate-y-0.5 transition-all duration-200">
                    <i class="bi bi-people"></i>Manage Users
                </a>
                <a href="<?php echo e(route('datasets.index')); ?>" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-ink-700 dark:text-ink-300 bg-white dark:bg-ink-900 border border-ink-300 dark:border-ink-700 rounded-lg hover:bg-ink-50 dark:hover:bg-ink-800 hover:shadow-soft hover:-translate-y-0.5 transition-all duration-200">
                    <i class="bi bi-grid"></i>Browse Datasets
                </a>
                <a href="<?php echo e(route('profile')); ?>" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-ink-700 dark:text-ink-300 bg-white dark:bg-ink-900 border border-ink-300 dark:border-ink-700 rounded-lg hover:bg-ink-50 dark:hover:bg-ink-800 hover:shadow-soft hover:-translate-y-0.5 transition-all duration-200">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>