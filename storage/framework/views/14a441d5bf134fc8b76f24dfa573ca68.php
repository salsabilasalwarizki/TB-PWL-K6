<?php $__env->startSection('title', 'Forgot Password - DataSphere'); ?>
        ...
        <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 p-8">
            ...
            <div class="mb-6 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-xl p-4 flex items-start gap-3">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-xs text-emerald-800 dark:text-emerald-300"><?php echo e(session('status')); ?></p>
                </div>
            </div>
            <?php endif; ?>

            <!-- Form -->
            <form id="forgotPasswordForm" method="POST" action="<?php echo e(route('password.email')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>