...
<?php $__env->startSection('title', 'Dataset Donation - Creators - DataSphere ML Repository'); ?>
<?php $__env->startSection('meta_desc', 'Step 3: Add creators for your dataset donation'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-brand-50/30 to-sphere-secondary/10 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 py-8 md:py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative max-w-4xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden mb-6">
            ...
            <div class="p-6 md:p-8 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-gray-800 dark:to-gray-800">
                ...
                <div class="hidden md:flex items-center gap-1 mb-3">
                    <?php for($i = 1; $i <= 7; $i++): ?>
                        <div class="flex-1 h-2 rounded-full <?php echo e($i <= 3 ? 'bg-gradient-to-r from-amber-500 to-orange-500' : 'bg-gray-200 dark:bg-gray-700'); ?>"></div>
                    <?php endfor; ?>
                </div>
        ...
        <!-- Form -->
        <form action="<?php echo e(route('contribute.creators.store')); ?>" method="POST" id="creatorsForm">
            <?php echo csrf_field(); ?>
                ...
                <div class="p-5 md:p-6 space-y-5">
                    ...
                    <div id="creators-container" class="space-y-4">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $creators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $creator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php echo $__env->make('contribute.partials.creator-item', [
                                'index' => $index,
                                'creator' => $creator,
                                'canRemove' => true
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-5 md:p-6 sticky bottom-4">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                    <a href="<?php echo e(route('contribute.paper')); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/contribute/creators.blade.php ENDPATH**/ ?>