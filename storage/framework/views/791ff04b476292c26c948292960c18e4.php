<?php $__env->startSection('title', 'Sign Up - DataSphere ML Repository'); ?>
<?php $__env->startSection('meta_desc', 'Create your DataSphere Machine Learning Repository account'); ?>
...
<div class="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12 bg-gradient-to-br from-gray-50 via-brand-50/30 to-sphere-secondary/10 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900">
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-8 md:p-10">
            ...
            <!-- Registration Form -->
            <form class="space-y-4" method="POST" action="<?php echo e(route('register')); ?>" id="registerForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="text-center text-sm text-gray-600 dark:text-gray-400 mt-8">
                ...
                <a href="<?php echo e(route('login')); ?>" class="font-semibold text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 transition-colors">
                    Sign in
                </a>
            </p>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/auth/register.blade.php ENDPATH**/ ?>