<?php $__env->startSection('title', 'Final Submission - DataSphere ML Repository'); ?>
<?php $__env->startSection('meta_desc', 'Step 7: Final review and submit your dataset'); ?>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('purpose', $data['descriptive']['purpose'] ?? '')); ?></textarea>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <p class="mt-1 text-xs text-red-500 flex items-center gap-1"><i class="bi bi-exclamation-circle"></i><?php echo e($message); ?></p>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="desc-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all resize-none"><?php echo e(old('funding', $data['descriptive']['funding'] ?? '')); ?></textarea>
                        <div class="flex justify-between mt-1.5">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="desc-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all resize-none <?php $__errorArgs = ['instances_represent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('instances_represent', $data['descriptive']['instances_represent'] ?? '')); ?></textarea>
                        <div class="flex justify-between mt-1.5">
                            <p class="text-xs text-gray-500 dark:text-gray-400">e.g., documents, photos, people, countries</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 char-counter">0 / 1000</p>
                        </div>
                        <?php $__errorArgs = ['instances_represent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="desc-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all resize-none"><?php echo e(old('data_splits', $data['descriptive']['data_splits'] ?? '')); ?></textarea>
                        <div class="flex justify-between mt-1.5">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="desc-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all resize-none"><?php echo e(old('sensitive_data', $data['descriptive']['sensitive_data'] ?? 'None')); ?></textarea>
                        <div class="flex justify-between mt-1.5">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="desc-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all resize-none"><?php echo e(old('preprocessing', $data['descriptive']['preprocessing'] ?? '')); ?></textarea>
                        <div class="flex justify-between mt-1.5">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="desc-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all resize-none"><?php echo e(old('additional_info', $data['descriptive']['additional_info'] ?? '')); ?></textarea>
                        <div class="flex justify-between mt-1.5">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="desc-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all resize-none"><?php echo e(old('citation_requests', $data['descriptive']['citation_requests'] ?? '')); ?></textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div class="flex items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 border border-emerald-200 dark:border-emerald-800">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm font-bold text-gray-900 dark:text-white truncate"><?php echo e($data['name'] ?? 'Not provided'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border border-blue-200 dark:border-blue-800">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm font-bold text-gray-900 dark:text-white"><?php echo e($data['num_instances'] ?? 'Not provided'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 border border-purple-200 dark:border-purple-800">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm font-bold text-gray-900 dark:text-white"><?php echo e($data['num_features'] ?? 'Not provided'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border border-amber-200 dark:border-amber-800">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm font-bold text-gray-900 dark:text-white truncate"><?php echo e($data['subject_area'] ?? 'Not provided'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-rose-50 to-pink-50 dark:from-rose-900/20 dark:to-pink-900/20 border border-rose-200 dark:border-rose-800">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm font-bold text-gray-900 dark:text-white truncate">
                                    <?php echo e(!empty($data['associated_tasks']) ? implode(', ', $data['associated_tasks']) : 'Not provided'); ?>
                        ...
                        <div class="flex items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 border border-teal-200 dark:border-teal-800">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm font-bold text-gray-900 dark:text-white"><?php echo e(count($data['files'] ?? [])); ?> file(s)</p>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2 flex items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 border border-indigo-200 dark:border-indigo-800">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm font-bold text-gray-900 dark:text-white">
                                    <?php echo e(!empty($data['keywords']) ? count($data['keywords']) . ' keyword(s)' : 'None'); ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-5 md:p-6 sticky bottom-4">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                    <a href="<?php echo e(route('contribute.variable-info')); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/contribute/descriptive.blade.php ENDPATH**/ ?>