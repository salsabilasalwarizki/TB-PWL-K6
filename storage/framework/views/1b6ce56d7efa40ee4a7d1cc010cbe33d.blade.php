...
- There is no ___SINGLE_BACKTICK___bootstrap/app.php___SINGLE_BACKTICK___ application configuration in a Laravel 10 structure:
    - Middleware registration happens in ___SINGLE_BACKTICK___{{ $assist->appPath('Http/Kernel.php') }}___SINGLE_BACKTICK___
    - Exception handling is in ___SINGLE_BACKTICK___{{ $assist->appPath('Exceptions/Handler.php') }}___SINGLE_BACKTICK___
    - Console commands and schedule register in ___SINGLE_BACKTICK___{{ $assist->appPath('Console/Kernel.php') }}___SINGLE_BACKTICK___
...
- In Laravel 12, middleware are no longer registered in ___SINGLE_BACKTICK___{{ $assist->appPath('Http/Kernel.php') }}___SINGLE_BACKTICK___.
...
- The ___SINGLE_BACKTICK___{{ $assist->appPath('Console/Kernel.php') }}___SINGLE_BACKTICK___ file no longer exists; use ___SINGLE_BACKTICK___bootstrap/app.php___SINGLE_BACKTICK___ or ___SINGLE_BACKTICK___routes/console.php___SINGLE_BACKTICK___ for console configuration.
- Console commands in ___SINGLE_BACKTICK___{{ $assist->appPath('Console/Commands/') }}___SINGLE_BACKTICK___ are automatically available and do not require manual registration.
@endif
