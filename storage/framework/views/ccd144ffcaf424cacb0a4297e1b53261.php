...
<div class="space-y-6 animate-fade-in">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-ink-700 dark:text-ink-300 bg-white dark:bg-ink-800 border border-ink-300 dark:border-ink-600 rounded-lg hover:bg-ink-50 dark:hover:bg-ink-700 transition-all">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 animate-slide-up">
        <div class="bg-white dark:bg-ink-800 rounded-xl shadow-card border border-ink-200 dark:border-ink-700 p-6 hover:-translate-y-0.5 hover:shadow-elev transition-all duration-300">
            <div class="flex flex-col items-center text-center">
                ...
                <p class="text-3xl font-bold text-ink-900 dark:text-white"><?php echo e(number_format($stats['total_datasets'] ?? 0)); ?></p>
                ...
                <div class="flex items-center gap-1 mt-2 text-xs text-green-600 dark:text-green-400">
                    ...
                    <span><?php echo e($stats['new_this_month'] ?? 0); ?> this month</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-ink-800 rounded-xl shadow-card border border-ink-200 dark:border-ink-700 p-6 hover:-translate-y-0.5 hover:shadow-elev transition-all duration-300">
            <div class="flex flex-col items-center text-center">
                ...
                <p class="text-3xl font-bold text-ink-900 dark:text-white"><?php echo e(number_format($stats['total_users'] ?? 0)); ?></p>
        ...
        <div class="bg-white dark:bg-ink-800 rounded-xl shadow-card border border-ink-200 dark:border-ink-700 p-6 hover:-translate-y-0.5 hover:shadow-elev transition-all duration-300">
            <div class="flex flex-col items-center text-center">
                ...
                <p class="text-3xl font-bold text-ink-900 dark:text-white"><?php echo e(number_format($stats['total_papers'] ?? 0)); ?></p>
        ...
        <div class="bg-white dark:bg-ink-800 rounded-xl shadow-card border border-ink-200 dark:border-ink-700 p-6 hover:-translate-y-0.5 hover:shadow-elev transition-all duration-300">
            <div class="flex flex-col items-center text-center">
                ...
                <p class="text-3xl font-bold text-ink-900 dark:text-white"><?php echo e(number_format($stats['total_downloads'] ?? 0)); ?></p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 animate-slide-up" style="animation-delay: 0.1s;">
        <div class="bg-white dark:bg-ink-800 rounded-xl shadow-card border border-ink-200 dark:border-ink-700 p-6 hover:-translate-y-0.5 hover:shadow-elev transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-3xl font-bold text-green-600 dark:text-green-400"><?php echo e(number_format($stats['approved_datasets'] ?? 0)); ?></p>
        ...
        <div class="bg-white dark:bg-ink-800 rounded-xl shadow-card border border-ink-200 dark:border-ink-700 p-6 hover:-translate-y-0.5 hover:shadow-elev transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-3xl font-bold text-amber-600 dark:text-amber-400"><?php echo e(number_format($stats['pending_datasets'] ?? 0)); ?></p>
        ...
        <div class="bg-white dark:bg-ink-800 rounded-xl shadow-card border border-ink-200 dark:border-ink-700 p-6 hover:-translate-y-0.5 hover:shadow-elev transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-3xl font-bold text-red-600 dark:text-red-400"><?php echo e(number_format($stats['rejected_datasets'] ?? 0)); ?></p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-slide-up" style="animation-delay: 0.4s;">
        ...
        <div class="bg-white dark:bg-ink-800 rounded-xl shadow-card border border-ink-200 dark:border-ink-700 overflow-hidden">
            ...
            <div class="p-6">
                <?php if(isset($stats['top_keywords']) && count($stats['top_keywords']) > 0): ?>
                    <div class="space-y-3">
                        <?php $__currentLoopData = $stats['top_keywords']->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $keyword): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-3 rounded-lg bg-ink-50 dark:bg-ink-700/50 hover:bg-ink-100 dark:hover:bg-ink-700 transition-colors">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="font-semibold text-ink-900 dark:text-white"><?php echo e($keyword->keyword_name); ?></span>
                                </div>
                                <span class="px-3 py-1 text-sm font-semibold text-brand-700 dark:text-brand-400 bg-brand-100 dark:bg-brand-900/30 rounded-full">
                                    <?php echo e(number_format($keyword->datasets_count)); ?> datasets
                                </span>
                            </div>
        ...
        <div class="bg-white dark:bg-ink-800 rounded-xl shadow-card border border-ink-200 dark:border-ink-700 overflow-hidden">
            ...
            <div class="p-6">
                <?php if(isset($stats['recent_downloads']) && count($stats['recent_downloads']) > 0): ?>
                    <div class="space-y-3">
                        <?php $__currentLoopData = $stats['recent_downloads']->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $download): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-3 rounded-lg bg-ink-50 dark:bg-ink-700/50 hover:bg-ink-100 dark:hover:bg-ink-700 transition-colors">
                                <div class="flex-1">
                                    <p class="font-semibold text-ink-900 dark:text-white"><?php echo e($download->name ?? 'Unknown Dataset'); ?></p>
                                    <div class="flex items-center gap-1 mt-1 text-xs text-ink-500 dark:text-ink-400">
                                        <i class="bi bi-clock"></i>
                                        <span><?php echo e($download->created_at->diffForHumans()); ?></span>
                                    </div>
                                </div>
                                <span class="px-3 py-1 text-sm font-semibold text-green-700 dark:text-green-400 bg-green-100 dark:bg-green-900/30 rounded-full">
                                    <?php echo e(number_format($download->download_count ?? 0)); ?> downloads
                                </span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const statusData = <?php echo json_encode($stats['datasets_by_status'] ?? [], 15, 512) ?>;
    ...
    const dataTypeData = <?php echo json_encode($stats['data_type_counts'] ?? [], 15, 512) ?>;
    ...
    const subjectAreaData = <?php echo json_encode($stats['by_subject_area'] ?? [], 15, 512) ?>;
    ...
    const monthlyGrowthData = <?php echo json_encode($stats['monthly_growth'] ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/admin/statistics.blade.php ENDPATH**/ ?>