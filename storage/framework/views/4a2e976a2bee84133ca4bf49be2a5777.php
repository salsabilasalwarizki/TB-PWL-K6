...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('meta_desc', 'DataSphere Machine Learning Repository'); ?>">
    <title><?php echo $__env->yieldContent('title', 'DataSphere ML Repository'); ?></title>
    ...
    <nav class="navbar-glass sticky top-0 z-50 transition-all duration-300" id="mainNavbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 lg:h-20">
                ...
                <!-- Logo -->
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 lg:gap-3 group flex-shrink-0">
                ...
                <div class="hidden xl:flex items-center gap-1">
                    ...
                    <div class="relative group">
                        ...
                        <div class="dropdown-menu-custom absolute left-0 mt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                            <a href="<?php echo e(route('contribute.policy')); ?>" class="dropdown-item-custom text-gray-700 dark:text-gray-200">
                            ...
                            <a href="<?php echo e(route('contribute.linking.metadata')); ?>" class="dropdown-item-custom text-gray-700 dark:text-gray-200">
                    ...
                    <div class="relative group">
                        ...
                        <div class="dropdown-menu-custom absolute left-0 mt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                            <a href="<?php echo e(route('about.who-we-are')); ?>" class="dropdown-item-custom text-gray-700 dark:text-gray-200">
                                <i class="bi bi-people-fill text-brand-500"></i>
                                <span class="font-semibold">Who We Are</span>
                            </a>
                            <div class="h-px bg-gray-100 dark:bg-gray-700 my-1"></div>
                            <a href="<?php echo e(route('about.citation')); ?>" class="dropdown-item-custom text-gray-700 dark:text-gray-200">
                                <i class="bi bi-quote text-sphere-secondary"></i>
                                <span class="font-semibold">Citation Metadata</span>
                            </a>
                            <div class="h-px bg-gray-100 dark:bg-gray-700 my-1"></div>
                            <a href="<?php echo e(route('about.contact')); ?>" class="dropdown-item-custom text-gray-700 dark:text-gray-200">
                ...
                <div class="flex items-center gap-2 lg:gap-3">
                    <!-- Desktop Search -->
                    <form action="<?php echo e(route('datasets.index')); ?>" method="GET" class="hidden lg:block flex-shrink-0">
                        <div class="relative">
                            <i class="bi bi-search absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm"></i>
                            <input type="search" name="q" value="<?php echo e(request('q')); ?>" placeholder="Search datasets..."
                        ...
                        <div class="hidden lg:block relative group flex-shrink-0">
                            ...
                            <div class="dropdown-menu-custom absolute right-0 mt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 w-56">
                                <div class="px-3 py-2 border-b border-gray-100 dark:border-gray-700 mb-1">
                                    <div class="font-semibold text-sm text-gray-900 dark:text-gray-100"><?php echo e(auth()->user()->name); ?></div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400 truncate"><?php echo e(auth()->user()->email); ?></div>
                                </div>
                                <a href="<?php echo e(route('profile')); ?>" class="dropdown-item-custom text-gray-700 dark:text-gray-200">
                                    <i class="bi bi-person-circle text-brand-500"></i>
                                    <span class="font-semibold">My Profile</span>
                                </a>
                                <a href="<?php echo e(route('profile.datasets')); ?>" class="dropdown-item-custom text-gray-700 dark:text-gray-200">
            ...
            <div id="mobileSearch" class="hidden lg:hidden pb-3">
                <form action="<?php echo e(route('datasets.index')); ?>" method="GET">
                    <div class="relative">
        ...
        <div class="mobile-panel absolute right-0 top-0 h-full w-full max-w-sm bg-white dark:bg-gray-900 shadow-2xl translate-x-full" id="mobileMenuPanel">
            <div class="flex flex-col h-full">
                <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <button onclick="toggleMobileMenu()" class="w-10 h-10 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center justify-center transition-colors">
                ...
                <div class="flex-1 overflow-y-auto py-4">
                    <div class="px-4 space-y-1">
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(auth()->user()->role === 'admin' || auth()->user()->role === 'superadmin'): ?>
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 font-medium">
                        ...
                        <a href="<?php echo e(route('datasets.index')); ?>" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                        ...
                        <a href="<?php echo e(route('contribute.policy')); ?>" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                            <i class="bi bi-cloud-arrow-up text-lg text-green-500"></i>
                            <span>Donate New</span>
                        </a>
                        <a href="<?php echo e(route('contribute.linking.metadata')); ?>" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                        ...
                        <a href="<?php echo e(route('about.who-we-are')); ?>" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                            <i class="bi bi-people-fill text-lg text-brand-500"></i>
                            <span>Who We Are</span>
                        </a>
                        <a href="<?php echo e(route('about.citation')); ?>" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                            <i class="bi bi-quote text-lg text-purple-500"></i>
                            <span>Citation Metadata</span>
                        </a>
                        <a href="<?php echo e(route('about.contact')); ?>" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <a href="<?php echo e(route('profile')); ?>" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                                <i class="bi bi-person-circle text-lg text-brand-500"></i>
                                <span>My Profile</span>
                            </a>
                            <a href="<?php echo e(route('profile.datasets')); ?>" class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                ...
                <div class="p-4 border-t border-gray-200 dark:border-gray-700 space-y-2 bg-gray-50 dark:bg-gray-800/50">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <form method="POST" action="<?php echo e(route('logout')); ?>">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="mobile-menu-item w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 font-semibold hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors">
                                <i class="bi bi-box-arrow-right"></i>
                                <span>Logout</span>
                            </button>
                        </form>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="mobile-menu-item w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-r from-brand-600 to-sphere-secondary text-white font-semibold shadow-lg hover:shadow-xl transition-all">
                            <i class="bi bi-box-arrow-in-right"></i>
                            <span>Login</span>
                        </a>
                    <?php endif; ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="py-12 border-b border-gray-200 dark:border-gray-800">
                <div class="max-w-3xl mx-auto text-center">
                    ...
                    <form class="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                        ...
                        <button type="submit"
                                class="px-6 py-3 rounded-full bg-gradient-to-r from-brand-600 to-sphere-secondary text-white font-semibold hover:shadow-lg hover:shadow-brand-500/30 transition-all hover:-translate-y-0.5 whitespace-nowrap">
                            Subscribe
                        </button>
                    </form>
            ...
            <div class="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('about.who-we-are')); ?>" class="footer-link text-sm text-gray-600 dark:text-gray-400 hover:text-brand-600 dark:hover:text-brand-400">About Us</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('home')); ?>" class="footer-link text-sm text-gray-600 dark:text-gray-400 hover:text-brand-600 dark:hover:text-brand-400">Home</a></li>
                        <li><a href="<?php echo e(route('datasets.index')); ?>" class="footer-link text-sm text-gray-600 dark:text-gray-400 hover:text-brand-600 dark:hover:text-brand-400">View Datasets</a></li>
                        <li><a href="<?php echo e(route('contribute.policy')); ?>" class="footer-link text-sm text-gray-600 dark:text-gray-400 hover:text-brand-600 dark:hover:text-brand-400">Donate a Dataset</a></li>
                        <li><a href="<?php echo e(route('about.citation')); ?>" class="footer-link text-sm text-gray-600 dark:text-gray-400 hover:text-brand-600 dark:hover:text-brand-400">Citation Guide</a></li>
                    </ul>
                </div>
            ...
            <div class="py-6 border-t border-gray-200 dark:border-gray-800">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div class="flex flex-wrap justify-center md:justify-start gap-6 text-xs text-gray-600 dark:text-gray-400">
                        <a href="<?php echo e(route('about.contact')); ?>" class="footer-link hover:text-brand-600 dark:hover:text-brand-400">Contact</a>
                    ...
                    <div class="text-center md:text-right">
                        <p class="text-xs text-gray-600 dark:text-gray-400">
                            © <?php echo e(date('Y')); ?> <span class="font-semibold gradient-text">DataSphere</span> ML Repository
                        </p>
...
</html><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/layouts/auth.blade.php ENDPATH**/ ?>