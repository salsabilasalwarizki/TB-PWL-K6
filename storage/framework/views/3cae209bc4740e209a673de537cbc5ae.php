...
<?php $__env->startSection('title', 'Who We Are - DataSphere'); ?>
<?php $__env->startSection('meta_desc', 'Learn about DataSphere Machine Learning Repository and our mission'); ?>
        ...
        <div class="space-y-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="text-center p-6 rounded-xl bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow">
                        <div class="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden border-4 border-brand-500 dark:border-brand-400">
                            <img src="<?php echo e(asset('images/about/ourmembers/salwa.png')); ?>" alt="Salsabila Salwa Rizki" class="w-full h-full object-cover">
                        </div>
                    ...
                    <div class="text-center p-6 rounded-xl bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow">
                        <div class="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden border-4 border-brand-500 dark:border-brand-400">
                            <img src="<?php echo e(asset('images/about/ourmembers/jesqueen.png')); ?>" alt="Jesqueen Maria Purba" class="w-full h-full object-cover">
                        </div>
                    ...
                    <div class="text-center p-6 rounded-xl bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow">
                        <div class="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden border-4 border-brand-500 dark:border-brand-400">
                            <img src="<?php echo e(asset('images/about/ourmembers/fadila.png')); ?>" alt="Fadila Lisma Sari" class="w-full h-full object-cover">
                        </div>
                    ...
                    <div class="text-center p-6 rounded-xl bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow">
                        <div class="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden border-4 border-brand-500 dark:border-brand-400">
                            <img src="<?php echo e(asset('images/about/ourmembers/syifa.png')); ?>" alt="Syifa Nazira" class="w-full h-full object-cover">
                        </div>
                    ...
                    <div class="text-center p-6 rounded-xl bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow md:col-span-2 lg:col-span-1 lg:col-start-2">
                        <div class="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden border-4 border-brand-500 dark:border-brand-400">
                            <img src="<?php echo e(asset('images/about/ourmembers/jelita.png')); ?>" alt="Jelita Hati Sinurat" class="w-full h-full object-cover">
                        </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 md:p-8">
                <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <a href="<?php echo e(route('about.contact')); ?>" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-brand-600 to-sphere-secondary text-white font-semibold shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/about/who-we-are.blade.php ENDPATH**/ ?>