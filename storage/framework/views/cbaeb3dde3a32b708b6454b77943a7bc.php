...
<body>
    ...
    <div class="content">
        <div class="info-box">
            ...
            <div class="value"><?php echo e($data['name']); ?> &lt;<?php echo e($data['email']); ?>&gt;</div>
            
            <div class="label">Subject</div>
            <div class="value" style="color: #6366f1; font-weight: 600;"><?php echo e($data['subject']); ?></div>
            
            <div class="label">Received</div>
            <div class="value"><?php echo e(now()->format('l, F j, Y \a\t g:i A')); ?> WIB</div>
        </div>
        
        <div class="message-box">
            <div class="label">Message</div>
            <div style="white-space: pre-wrap; color: #333; font-size: 14px; line-height: 1.8;"><?php echo e($data['message']); ?></div>
        </div>
    </div>
    
    <div class="footer">
        <p>This email was sent from the DataSphere contact form.</p>
        <p>Reply directly to this email to respond to <?php echo e($data['name']); ?>.</p>
    </div>
</body>
</html><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/emails/contact.blade.php ENDPATH**/ ?>