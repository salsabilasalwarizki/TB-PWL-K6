...
<?php $__env->startSection('title', 'Donation Policy - DataSphere ML Repository'); ?>
<?php $__env->startSection('meta_desc', 'Learn about the donation policy for contributing datasets to DataSphere'); ?>
                ...
                <?php else: ?>
                    ...
                    <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            <a href="<?php echo e(route('login')); ?>" class="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-brand-600 to-sphere-secondary text-white font-semibold shadow-lg hover:shadow-xl hover:shadow-brand-500/30 hover:-translate-y-0.5 transition-all">
                                <i class="bi bi-box-arrow-in-right"></i>
                                <span>Login to Agree & Contribute</span>
                            </a>
                            <a href="<?php echo e(route('register')); ?>" class="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200 font-semibold hover:bg-gray-50 dark:hover:bg-gray-600 hover:-translate-y-0.5 transition-all">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/contribute/policy.blade.php ENDPATH**/ ?>