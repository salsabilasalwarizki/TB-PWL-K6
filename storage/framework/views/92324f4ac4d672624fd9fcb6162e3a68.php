...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('meta_desc', 'DataSphere Machine Learning Repository - A curated collection of datasets for ML research'); ?>">
    <title><?php echo $__env->yieldContent('title', 'DataSphere Machine Learning Repository'); ?></title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 lg:h-20">
                ...
                <div class="hidden lg:flex items-center gap-1">
                    ...
                    <div class="relative group">
                        ...
                        <div class="dropdown-menu-custom absolute left-0 mt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                            ...
                            <a href="<?php echo e(route('contribute.linking.policy')); ?>" class="dropdown-item-custom text-gray-700 dark:text-gray-200">
                ...
                <div class="flex items-center gap-2 lg:gap-3">
                    <!-- Desktop Search -->
                    <form action="<?php echo e(route('datasets.index')); ?>" method="GET" class="hidden md:block flex-shrink-0">
                        <div class="relative">
            ...
            <div class="flex flex-col h-full">
                ...
                <div class="flex-1 overflow-y-auto py-4">
                    <div class="px-4 space-y-1">
                        ...
                        <a href="<?php echo e(route('contribute.linking.policy')); ?>" 
                           class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                        ...
                        <a href="<?php echo e(route('about.who-we-are')); ?>" 
                           class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
                            <i class="bi bi-people-fill text-lg text-brand-500"></i>
                            <span>Who We Are</span>
                        </a>
                        <a href="<?php echo e(route('about.citation')); ?>" 
                           class="mobile-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="py-12 border-b border-gray-200 dark:border-gray-800">
                <div class="max-w-3xl mx-auto text-center">
                    ...
                    <!-- Newsletter Form -->
                    <form id="newsletterForm" action="<?php echo e(route('newsletter.subscribe')); ?>" method="POST" class="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                        <?php echo csrf_field(); ?>
                    ...
                    <p class="text-red-500 text-sm mt-3"><?php echo e($errors->first('email')); ?></p>
                    <?php endif; ?>
...
</html><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/layouts/app.blade.php ENDPATH**/ ?>