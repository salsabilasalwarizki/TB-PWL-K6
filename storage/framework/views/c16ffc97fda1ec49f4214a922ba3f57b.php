...
<?php $__env->startSection('title', 'Citation Metadata - DataSphere'); ?>
<?php $__env->startSection('meta_desc', 'Learn how to properly cite datasets from DataSphere Machine Learning Repository'); ?>
            ...
            <div class="bg-gradient-to-br from-brand-600 via-sphere-primary to-sphere-secondary rounded-2xl p-6 md:p-8 text-white shadow-xl">
                <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    ...
                    <div class="flex gap-3">
                        <a href="<?php echo e(route('datasets.index')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white text-brand-700 font-semibold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/about/citation.blade.php ENDPATH**/ ?>