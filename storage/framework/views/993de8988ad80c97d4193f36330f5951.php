...
<?php $__env->startSection('title', 'Edit Datasets - DataSphere'); ?>
                        ...
                        <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($datasets->total()); ?> datasets available for editing</p>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                            ...
                                            <td class="px-6 py-4">
                                                ...
                                                <div class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                                    <?php echo e($dataset->updated_at?->format('M d, Y') ?? ''); ?>
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex items-center gap-1.5 text-sm text-gray-600 dark:text-gray-400">
                                                    <i class="bi bi-eye"></i>
                                                    <span class="font-semibold"><?php echo e(number_format($dataset->view_count ?? 0)); ?></span>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4">
                            ...
                            <div class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold <?php echo e($statusStyles); ?>">
                                            <?php echo e(ucfirst($dataset->status)); ?>

                                        </span>
                                        <span class="text-xs text-gray-500 dark:text-gray-400">
                                            <i class="bi bi-eye mr-1"></i><?php echo e(number_format($dataset->view_count ?? 0)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/profile/edits.blade.php ENDPATH**/ ?>