...
<?php $__env->startSection('title', 'Link External Dataset - Descriptive - DataSphere ML Repository'); ?>
<?php $__env->startSection('meta_desc', 'Final step: Add descriptive information for linking your external dataset'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-brand-50/30 to-sphere-secondary/10 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 py-8 md:py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative max-w-4xl mx-auto">
        ...
        <!-- Form -->
        <form action="<?php echo e(route('contribute.linking.submit')); ?>" method="POST" id="linkingForm">
            <?php echo csrf_field(); ?>
                ...
                <div class="p-5 md:p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="desc-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all resize-none"><?php echo e(old('funding', $data['funding'] ?? '')); ?></textarea>
                        <div class="flex justify-between mt-1.5">
                            <p class="text-xs text-gray-500 dark:text-gray-400">Optional: List funding sources</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400"><span id="fundingCount"><?php echo e(strlen(old('funding', $data['funding'] ?? ''))); ?></span>/1000</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="desc-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all resize-none"><?php echo e(old('instances_represent', $data['instances_represent'] ?? '')); ?></textarea>
                        <div class="flex justify-between mt-1.5">
                            <p class="text-xs text-gray-500 dark:text-gray-400">e.g., documents, photos, people, countries</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400"><span id="instancesCount"><?php echo e(strlen(old('instances_represent', $data['instances_represent'] ?? ''))); ?></span>/1000</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="desc-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all resize-none"><?php echo e(old('data_splits', $data['data_splits'] ?? '')); ?></textarea>
                        <div class="flex justify-between mt-1.5">
                            <p class="text-xs text-gray-500 dark:text-gray-400">e.g., training, validation, testing</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400"><span id="splitsCount"><?php echo e(strlen(old('data_splits', $data['data_splits'] ?? ''))); ?></span>/1000</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="desc-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all resize-none"><?php echo e(old('sensitive_data', $data['sensitive_data'] ?? '')); ?></textarea>
                        <div class="flex justify-between mt-1.5">
                            <p class="text-xs text-gray-500 dark:text-gray-400">e.g., racial origins, sexual orientations, religious beliefs</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400"><span id="sensitiveCount"><?php echo e(strlen(old('sensitive_data', $data['sensitive_data'] ?? ''))); ?></span>/2000</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="desc-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all resize-none"><?php echo e(old('preprocessing', $data['preprocessing'] ?? '')); ?></textarea>
                        <div class="flex justify-between mt-1.5">
                            <p class="text-xs text-gray-500 dark:text-gray-400">e.g., discretization, tokenization, missing value handling</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400"><span id="preprocessingCount"><?php echo e(strlen(old('preprocessing', $data['preprocessing'] ?? ''))); ?></span>/2000</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="desc-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all resize-none"><?php echo e(old('additional_info', $data['additional_info'] ?? '')); ?></textarea>
                        <div class="flex justify-between mt-1.5">
                            <p class="text-xs text-gray-500 dark:text-gray-400">Optional: Any other relevant information</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400"><span id="additionalCount"><?php echo e(strlen(old('additional_info', $data['additional_info'] ?? ''))); ?></span>/2000</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            class="desc-textarea w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all resize-none"><?php echo e(old('citation_requests', $data['citation_requests'] ?? '')); ?></textarea>
                        <div class="flex justify-between mt-1.5">
                            <p class="text-xs text-gray-500 dark:text-gray-400">How should users cite this dataset?</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400"><span id="citationCount"><?php echo e(strlen(old('citation_requests', $data['citation_requests'] ?? ''))); ?></span>/2000</p>
                        </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start gap-3 p-4 rounded-xl bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border border-indigo-200 dark:border-indigo-800">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm font-bold text-gray-900 dark:text-white truncate"><?php echo e($data['name'] ?? 'N/A'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3 p-4 rounded-xl bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border border-indigo-200 dark:border-indigo-800">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <a href="<?php echo e($data['external_url'] ?? '#'); ?>" target="_blank" class="text-sm font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 truncate block">
                                    <?php echo e($data['external_url'] ?? 'N/A'); ?>
                        ...
                        <div class="flex items-start gap-3 p-4 rounded-xl bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border border-indigo-200 dark:border-indigo-800">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm font-bold text-gray-900 dark:text-white truncate"><?php echo e($data['subject_area'] ?? 'N/A'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-5 md:p-6 sticky bottom-4">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                    <a href="<?php echo e(route('contribute.linking.variable-info')); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/linking/descriptive.blade.php ENDPATH**/ ?>