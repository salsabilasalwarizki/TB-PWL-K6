...
<?php $__env->startSection('meta_desc', Str::limit($dataset->description ?? $dataset->abstract, 160)); ?>
    ...
    <section class="relative overflow-hidden bg-gradient-to-br from-brand-600 via-sphere-primary to-sphere-secondary text-white">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14">
            ...
            <nav class="flex items-center gap-2 text-sm text-white/70 mb-4">
                ...
                <a href="<?php echo e(route('profile.datasets')); ?>" class="hover:text-white transition-colors">My Datasets</a>
                <i class="bi bi-chevron-right text-xs"></i>
                <span class="text-white truncate max-w-xs"><?php echo e(Str::limit($dataset->name, 40)); ?></span>
            </nav>
            ...
            <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex flex-wrap items-center gap-2 mb-2">
                        ...
                        <?php if($dataset->is_public ?? false): ?>
                        <span class="px-2.5 py-1 rounded-full bg-white/15 backdrop-blur-sm border border-white/20 text-xs font-semibold">
                ...
                <div class="flex gap-2 flex-shrink-0">
                    ...
                    <button onclick="toggleVisibility()" id="visibilityBtn"
                        ...
                        <i class="bi bi-<?php echo e(($dataset->is_public ?? false) ? 'globe' : 'lock'); ?>"></i>
                        <span class="hidden sm:inline"><?php echo e(($dataset->is_public ?? false) ? 'Public' : 'Private'); ?></span>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="grid lg:grid-cols-[1fr_320px] gap-6">
            ...
            <div class="space-y-6 min-w-0">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    ...
                    <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
                        <?php echo e($dataset->description ?? $dataset->abstract ?? 'No description available.'); ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <div id="datasetInfoSection" class="px-5 pb-5 space-y-4">
                        <div class="p-4 rounded-xl bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($dataset->has_missing_values ? 'Yes' : 'No'); ?></p>
                        </div>
                        <?php if(!empty($descriptiveInfo)): ?>
                            <?php if($descriptiveInfo['purpose'] ?? null): ?>
                            <div class="p-4 rounded-xl bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700">
                                <h4 class="text-sm font-semibold text-gray-900 dark:text-white mb-1">Purpose</h4>
                                <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed"><?php echo e($descriptiveInfo['purpose']); ?></p>
                            </div>
                            <?php endif; ?>
                            <?php if($descriptiveInfo['instances_represent'] ?? null): ?>
                            <div class="p-4 rounded-xl bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700">
                                <h4 class="text-sm font-semibold text-gray-900 dark:text-white mb-1">Instances Represent</h4>
                                <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed"><?php echo e($descriptiveInfo['instances_represent']); ?></p>
                            </div>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <button type="button" onclick="toggleSection('paperSection')" class="w-full p-5 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($dataset->papers->count()); ?> papers</p>
                            </div>
                        </div>
                    ...
                    <div id="paperSection" class="px-5 pb-5 space-y-3">
                        ...
                        <div class="p-4 rounded-xl bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700">
                            <?php if($paper->paper_url ?? $paper->url): ?>
                            <a href="<?php echo e($paper->paper_url ?? $paper->url); ?>" target="_blank" class="font-semibold text-gray-900 dark:text-white hover:text-brand-600 dark:hover:text-brand-400 transition-colors">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-gray-700/30 border border-gray-100 dark:border-gray-700 hover:border-brand-300 dark:hover:border-brand-700 transition-colors">
                                <div class="flex items-center gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        <p class="font-semibold text-sm text-gray-900 dark:text-white truncate"><?php echo e($file->original_filename); ?></p>
                                        <div class="flex items-center gap-2 mt-0.5">
                                            ...
                                            <span class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($file->file_size); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <a href="<?php echo e(route('datasets.download', [$dataset, $file])); ?>" 
                            ...
                            <table class="w-full text-sm">
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                        <td class="px-4 py-3 font-semibold text-gray-900 dark:text-white"><?php echo e($var->variable_name); ?></td>
                                        <td class="px-4 py-3">
                                            <?php
                                                $roleColors = [
                                        ...
                                        <td class="px-4 py-3 text-gray-600 dark:text-gray-400"><?php echo e($var->type); ?></td>
            ...
            <aside class="space-y-4 lg:sticky lg:top-24 lg:self-start">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                    ...
                    ?>
                    <?php if($dataset->files->isNotEmpty() && $dataset->files->first()): ?>
                    <a href="<?php echo e(route('datasets.download', [$dataset, $dataset->files->first()])); ?>" 
                       ...
                       download>
                        ...
                        <span>Download</span>
                        <?php if($totalSize): ?>
                            <span class="text-xs opacity-90">(<?php echo e(number_format($totalSize / 1024, 1)); ?> KB)</span>
                        <?php endif; ?>
                    </a>
                    <?php endif; ?>
                    ...
                    <div class="pt-4 border-t border-gray-100 dark:border-gray-700 space-y-2">
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span class="font-bold text-gray-900 dark:text-white"><?php echo e(number_format($totalCitations ?? 0)); ?></span>
                        </div>
                        <div class="flex items-center justify-between text-sm" data-view-count>
                            ...
                            <span class="font-bold text-gray-900 dark:text-white"><?php echo e(number_format($totalViews ?? 0)); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                    ...
                    <?php if($dataset->doi): ?>
                    <a href="<?php echo e($dataset->doi->resolution_url); ?>" 
                       target="_blank" 
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                    <h3 class="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3 flex items-center gap-2">
                        <i class="bi bi-person-badge"></i>Creators (<?php echo e($dataset->creators->count()); ?>)
                    </h3>
                    <div class="space-y-3">
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <span class="inline-block px-2 py-0.5 rounded bg-gray-100 dark:bg-gray-700 text-xs text-gray-600 dark:text-gray-400 mt-0.5"><?php echo e(ucfirst($creator->pivot->contribution_role)); ?></span>
                                <?php endif; ?>
                                <?php if($creator->affiliation): ?>
                                <p class="text-xs text-gray-500 dark:text-gray-400 truncate mt-0.5"><?php echo e($creator->affiliation); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                    ...
                    ?>
                    <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border text-sm font-semibold <?php echo e($statusStyles); ?>">
                    ...
                    <div class="mt-3 p-3 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
                        ...
                        <p class="text-xs text-amber-800 dark:text-amber-300 leading-relaxed"><?php echo e($dataset->admin_notes); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/profile/dataset-detail.blade.php ENDPATH**/ ?>