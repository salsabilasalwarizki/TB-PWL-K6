...
<?php $__env->startSection('title', 'Dataset Donation - Variables - DataSphere ML Repository'); ?>
<?php $__env->startSection('meta_desc', 'Step 6: Define variables for your dataset'); ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden mb-6">
            ...
            <div class="p-6 md:p-8 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-gray-800 dark:to-gray-800">
                ...
                <div class="hidden md:flex items-center gap-1 mb-3">
                    <?php for($i = 1; $i <= 7; $i++): ?>
                        <div class="flex-1 h-2 rounded-full <?php echo e($i <= 6 ? 'bg-gradient-to-r from-amber-500 to-orange-500' : 'bg-gray-200 dark:bg-gray-700'); ?>"></div>
                    <?php endfor; ?>
                </div>
        ...
        <form action="<?php echo e(route('contribute.variable-info.store')); ?>" method="POST" id="variablesForm">
                ...
                <div class="p-5 md:p-6 space-y-5">
                    ...
                    <div id="variables-container" class="space-y-4">
                        ...
                        <?php $__currentLoopData = $variablesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $var): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('contribute.partials.variable-item', [
                                'index' => $index,
                                'var' => $var,
                                'canRemove' => $index > 0
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-5 md:p-6 sticky bottom-4">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                    <a href="<?php echo e(route('contribute.keywords')); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Documents\TB-PWL-DATASPHERE\resources\views/contribute/variable-info.blade.php ENDPATH**/ ?>