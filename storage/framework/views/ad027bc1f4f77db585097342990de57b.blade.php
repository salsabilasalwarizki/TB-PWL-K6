...
- This application uses PHPUnit for testing. All tests must be written as PHPUnit classes. Use ___SINGLE_BACKTICK___{{ $assist->artisanCommand('make:test --phpunit {name}') }}___SINGLE_BACKTICK___ to create a new test.
